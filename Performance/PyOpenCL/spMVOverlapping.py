...
if __name__ == "__main__":
    ...
    queues = [cl.CommandQueue(context, device=device) for i in range(2)] # , properties=cl.command_queue_properties.PROFILING_ENABLE
    ...
    for i in range(LOOP_COUNT):
        ...
        # eventM0.wait()
        # bandwidth = (indptr[halfSize]*srcM.shape[1]*9*8)/1e9/((eventM0.profile.end - eventM0.profile.start)*1e-9)
        # print('practice bandwidth is {} GBps'.format(bandwidth))
